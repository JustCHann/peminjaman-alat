<x-app-layout>
    ...
    <div class="min-h-screen bg-gray-50/80 flex">
        ...
        <main class="flex-1 flex flex-col min-h-screen bg-gray-50/80">
            ...
            <header class="bg-white/80 backdrop-blur-md border-b border-gray-200/60 px-6 md:px-8 py-4 sticky top-0 z-10 flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-2 text-sm md:text-base">
                        ...
                        <a href="{{ route('admin.users.index') }}" class="text-gray-600 hover:text-indigo-600 transition">Manajemen User</a>
                        <ion-icon name="chevron-forward-outline" class="text-gray-400 text-xs"></ion-icon>
                        <span class="font-semibold text-gray-800">Tambah User</span>
                    </div>
                </div>
            ...
            <!-- Page content - FORM TAMBAH USER -->
            <div class="p-6 md:p-8 flex-1">
                <!-- Header & tombol kembali -->
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800 tracking-tight">Tambah Pengguna Baru</h2>
                        <p class="text-sm text-gray-500 mt-1">Isi data dengan lengkap untuk menambahkan user ke sistem</p>
                    </div>
                    <a href="{{ route('admin.users.index') }}" class="inline-flex items-center gap-2 bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 px-5 py-2.5 rounded-xl shadow-sm transition font-medium text-sm self-start sm:self-center">
                        <ion-icon name="arrow-back-outline" class="text-lg"></ion-icon>
                        Kembali
                    </a>
                </div>

                <!-- Form Card - Desain sama persis dengan card table -->
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="username" value="{{ old('username') }}" 
                                       class="w-full px-4 py-3 border border-gray-200 bg-gray-50/50 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-300/50 focus:border-indigo-300 transition @error('username') border-red-300 bg-red-50/50 @enderror" 
                            ...
                            <div>
                                ...
                                <input type="email" name="email" value="{{ old('email') }}" 
                                       class="w-full px-4 py-3 border border-gray-200 bg-gray-50/50 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-300/50 focus:border-indigo-300 transition @error('email') border-red-300 bg-red-50/50 @enderror" 
                            ...
                            <div>
                                ...
                                <select name="role" 
                                        class="w-full px-4 py-3 border border-gray-200 bg-gray-50/50 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-300/50 focus:border-indigo-300 transition appearance-none @error('role') border-red-300 bg-red-50/50 @enderror">
                            ...
                            <div>
                                ...
                                <input type="password" name="password" 
                                       class="w-full px-4 py-3 border border-gray-200 bg-gray-50/50 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-300/50 focus:border-indigo-300 transition @error('password') border-red-300 bg-red-50/50 @enderror" 
                            ...
                            <div>
                                ...
                                <input type="password" name="password_confirmation" 
                                       class="w-full px-4 py-3 border border-gray-200 bg-gray-50/50 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-300/50 focus:border-indigo-300 transition" 
                                       placeholder="Ulangi password">
                            </div>
                        </div>
                        <!-- Action Buttons -->
                        <div class="flex items-center justify-end gap-3 mt-8 pt-6 border-t border-gray-100">
                            <a href="{{ route('admin.users.index') }}" class="px-6 py-2.5 border border-gray-200 bg-white hover:bg-gray-50 text-gray-700 rounded-xl transition font-medium text-sm">
                                Batal
                            </a>
    ...
    <div id="mobileSidebar" class="md:hidden fixed inset-0 z-50 hidden transition-opacity">
        ...
        <div class="absolute left-0 top-0 h-full w-72 bg-gradient-to-b from-indigo-800 to-indigo-900 shadow-xl">
            ...
            <div class="px-4 pt-4">
                ...
                <a href="/admin/alat" class="flex items-center gap-4 px-4 py-3 text-indigo-50/90 hover:bg-white/10 rounded-xl">Alat</a>
