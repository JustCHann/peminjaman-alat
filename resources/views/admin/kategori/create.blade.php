<x-app-layout>
    ...
    <div class="min-h-screen bg-gray-50/80 flex">
        ...
        <main class="flex-1 flex flex-col min-h-screen bg-gray-50/80">
            ...
            <header class="bg-white/80 backdrop-blur-md border-b border-gray-200/60 px-6 md:px-8 py-4 sticky top-0 z-10 flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-2 text-sm md:text-base">
                        ...
                        <ion-icon name="chevron-forward-outline" class="text-gray-400 text-xs"></ion-icon>
                        <span class="font-semibold text-gray-800">Tambah Kategori</span>
                    </div>
                </div>
            ...
            <!-- Page content - FORM TAMBAH KATEGORI -->
            <div class="p-6 md:p-8 flex-1">
                <!-- Header & tombol kembali -->
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800 tracking-tight">Tambah Kategori Baru</h2>
                        <p class="text-sm text-gray-500 mt-1">Buat kategori baru untuk pengelompokan alat</p>
                    </div>
                ...
                <!-- Form Card - Desain sama persis dengan tambah user & alat -->
